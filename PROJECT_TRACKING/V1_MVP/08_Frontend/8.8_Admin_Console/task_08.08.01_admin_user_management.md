...
## Specific Sub-tasks:
- [x] 1. Create User List View (`src/routes/(protected)/admin/users/+page.svelte`)
...
- [x] 4. User Detail View (Optional/Drawer)
    - [x] Show user profile summary (in table row)
    - [x] List assigned roles (role badge in table)
